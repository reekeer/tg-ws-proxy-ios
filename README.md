...
<details>
<summary><b>iLoader</b> — установка прямо с iPhone, без компьютера</summary>

1. Откройте iLoader и войдите под своим Apple ID.
2. Добавьте скачанный `.ipa` и запустите установку.

Интерфейс заметно меняется от версии к версии — ориентируйтесь на подсказки внутри приложения. Ограничения те же, что у Sideloadly: бесплатный аккаунт, 7 дней, три приложения.
